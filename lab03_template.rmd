...
# Outro pedaço (40%) da imagem, mas com as cores originais
ggplot(base_treino) + 
  geom_point(aes(x=x, y=y), colour=base_treino$cor) +
...
- Calcule o erro de predição dos dois modelos.

```{r}
## código aqui
```

- Compare os dados originais com o que foi predito nos dois modelos.
